...
import CardAtom from './atom_card.js'
        ...
        <Card key="HowToUse" style={{ marginTop: 80, marginRight: 12, marginBottom: 12, marginLeft: 12 }}>
          ...
          <CardActions>
            ...
            <RaisedButton
              ...
              secondary={true}
              target="_blank"
              href="https://github.com/TactOS/gentoo-build-server/issues"
            />
            <RaisedButton
              label="Web Front End Issue"
              secondary={true}
              target="_blank"
              href="https://github.com/TactOS/tactos-front/issues"
            />
          </CardActions>
        </Card>
